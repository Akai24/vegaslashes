<div class="blog-masonry-wrapper">
    <div class="isotopewrapper">
        ...
        $statement = array(
            ...
            'order'					=> "DESC",
            'paged' 				=> $paged,
            'posts_per_page'		=> vp_metabox('photology_blogcontent.post_perpage', null, $_REQUEST['blogid'])
        );


        if(vp_metabox('photology_blogcontent.toggle_filtering', null, $_REQUEST['blogid']) === '1')
        {
            $filter = vp_metabox('photology_blogcontent.filtering_group.0', null, $_REQUEST['blogid']);
