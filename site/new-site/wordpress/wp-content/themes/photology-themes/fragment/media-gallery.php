...
$itemwidthbase 	= vp_metabox('photology_media_gallery.item_width', null, JEG_PAGE_ID);
$itemheightdim 	= null;
$itemheightbase = '';


if($gallerylayout == 'normal') {
    $itemheightdim = floatval ( vp_metabox('photology_media_gallery.item_height', null, JEG_PAGE_ID) );
    $itemheightbase = $itemheightdim * $itemwidthbase;
} else if($gallerylayout === 'justified') {
    $itemheightbase = floatval ( vp_metabox('photology_media_gallery.justified_item_height', null, JEG_PAGE_ID) );
}

$usemargin =  vp_metabox('photology_media_gallery.use_margin', null, JEG_PAGE_ID);
$marginsize = 0;
$althidetitle = vp_metabox('photology_media_gallery.photoswipe_setting.0.photoswipe_hide_title', null, JEG_PAGE_ID);
$notloadedclass = 'notloaded';

if($usemargin) {
    $marginsize = vp_metabox('photology_media_gallery.margin_size',  null, JEG_PAGE_ID);
