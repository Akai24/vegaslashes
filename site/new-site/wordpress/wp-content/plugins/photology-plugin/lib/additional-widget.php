...
define('JEG_WIDGET_TEMPLATE_PATH'	, PHOTOLOGY_PLUGIN_DIR . '/lib/widget-template/');
...
class Jeg_Popular_Post_Widget extends Jeg_Widget {
    ...
    public function __construct() {
        ...
        parent::__construct(
            ...
            'Jegtheme - Popular Post Widget', // Name
...
class Jeg_Latest_Post_Widget extends Jeg_Widget {
    ...
    public function __construct() {
        ...
        parent::__construct(
            ...
            'Jegtheme - Latest Post Widget', // Name
