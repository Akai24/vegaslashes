				...
				$slidewrap.each(function(i) {
					var $oEl = $(this),
						...
						navMarkup = [
							...
							'	<li role="presentation"><a href="#' + currentSlider + '" class="' + opt.namespace + '-prev">&laquo; Prev</a> </li>',
							'	<li role="presentation"><a href="#' + currentSlider + '" class="' + opt.namespace + '-next"> Next &raquo;</a> </li>',
							'</ul>'
							].join(''),
						nextprev = {
